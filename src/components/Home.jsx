...
export const Home = () => {
  return (
    <div className="flex flex-col my-10 ">
      ...
      <div className="flex flex-col box-content rounded-lg  border-2 w-full h-56 bg-zinc-800 border-zinc-700">
        <form>
          <label
            for="Create a post"
          ...
          <div className="relative p-6 rounded-full pb-3 flex w-full justify-between">
            ...
            <div className="absolute  my-8 pl-4 border-transparent border-solid border-zinc-800 bg-transparent bg-zinc-700">
              <svg
                width="18"
                height="19"
                viewBox="0 0 18 19"
